...
public enum ActionPermissionEnum {
    ...
    ADDRESS_READ(ActionEnum.READ, "address.read", Address.class.getSimpleName()),
    ADDRESS_CREATE(ActionEnum.CREATE, "address.create", Address.class.getSimpleName()),
    ADDRESS_UPDATE(ActionEnum.UPDATE, "address.update", Address.class.getSimpleName()),
    ADDRESS_DELETE(ActionEnum.DELETE, "address.delete", Address.class.getSimpleName()),
        ...
        var ret = Arrays.stream(values())
                .filter(actionPermissionEnum ->
                        actionPermissionEnum.action.equals(action) &&
                                actionPermissionEnum.className.equalsIgnoreCase(clas.getSimpleName()))
                .findFirst();
