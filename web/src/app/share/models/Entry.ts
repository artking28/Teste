...
export class Entry extends Indexable<Entry> {
    id          :number
    uuid        :string
    tags        :string
    expense     :boolean
    ...
    public static adapt(object: Entry): Entry {
        let ret = Object.assign(new Entry(), object)
    ...
    public formToSelf(form: FormGroup): Entry {
        let ret = form.getRawValue();
        return Entry.adapt(ret)
    }
}
